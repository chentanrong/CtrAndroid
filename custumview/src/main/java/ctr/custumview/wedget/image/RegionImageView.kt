...
//                (displayRegionRaw * options.inSampleSize).toRect(),
//                optionRegion
//            )
...
//                set(
//                    width - dip(SIZE_SUSPENSION).toFloat(), 0f
...
//                //adapt the image
//                set(
//                    width - (dip(SIZE_SUSPENSION).toFloat() / bitmapHeight) * bitmapWidth, 0f,
...
//    )
//
//    private fun RectF.getMappingX(x: Float, src: RectF) =
//        (x - src.left) / src.width() * width() + left
//
//    private fun RectF.getMappingY(y: Float, src: RectF) =
//        (y - src.top) / src.height() * height() + top
//
