...
public class SweepStackView extends BaseView {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        rectF.left=padding - mRadius;
        rectF.top =padding - mRadius;
        rectF.right=mRadius -padding;
        rectF.bottom=mRadius - padding;
        sweepAngle = 360 / Num;
    ...
    public void startAnimation() {
        ...
        valueAnimator = ValueAnimator.ofInt(0, toDegree);
